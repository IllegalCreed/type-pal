...
test('a live link still fails when a fenced twin would have been a false positive', () => {
  const text = ['```md', '[假](missing.md)', '```', '[真](missing.md)'].join('\n')
  assert.deepEqual(markdownLinks(text), [{ target: 'missing.md', line: 4 }])
})
