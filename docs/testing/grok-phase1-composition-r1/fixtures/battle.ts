...
import type { BattleBgAsset } from '../../../../packages/game/src/present/battle/draw-battle-bg.js'
import type { Enemy, Item, PlayerRole, PlayerRoles } from '../../../../packages/shared/src/index.js'
