...
import type { BattleAnimState } from '../../../packages/game/src/core/battle/battle-state.js'
import { BattlePresent } from '../../../packages/game/src/present/battle/present-battle.js'
