...
const cases = [
  { name: 'control-timer', pkg: 'editor', group: 'timer', file: null, from: '', to: '', expected: 0 },
  { name: 'control-consent', pkg: 'editor', group: 'consent', file: null, from: '', to: '', expected: 0 },
  { name: 'control-timefmt', pkg: 'editor', group: 'timefmt', file: null, from: '', to: '', expected: 0 },
  {
  ...
  },
  {
    ...
    redTest: '不传 subscribePage：grant 发当前页一次；deny 停发且清 lastPath；regrant 同页可再发；stop 后零回调',
    expected: 1,
  },
  {
