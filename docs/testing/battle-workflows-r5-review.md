...
此签不代表已集成、官方统计门禁通过或 done；Kimi 额度耗尽，独立终审仍 pending，无缺签豁免。
...
用户明确Kimi额度耗尽：登记 unavailable；没有代班终审、没有用户缺签豁免，仍需后续独立补审或用户明确裁决。
风险是当前缺少该席最终实现审查，不否定已完成的Codex独立接收。旧兼容审查pass（产品未改）。
不标done，不改full/Q1/Q2边界。

无下一位Agent提示词，本轮不转Kimi；等待后续统一集成/门禁，再按额度恢复或用户裁决安排终审。
