...
2026-09-19最新状态：[TB-02～10九批统一接收](glm-nine-intake-review.md)已完成本轮独立复核，九批分别counter/rework；205定向、原73针+27对照、tc通过，但不满足证据/范围/格式验收，未合并、未改官方7049基线。
用户本轮明确批准额度空窗期九批先行实施，原“两批待接收”限制不追溯阻挡这九个交付；不把该例外泛化为未来新范围授权。
TB-00/TB-01另排。本轮返工优先；设计三签不重开（TB02/03 r2，TB04～10 r1已齐）。用户最新确认Mimosa为GLM私有MCP，Codex无需处理、不作本轮门禁；测试与质量门保持。
