...
- [六组内容合同补测工作包](glm-content-contracts.md)与[任务卡](../ops/tasks/TEST-CONTENT-CONTRACTS-1-content-validation-boundaries.md)（rework；dbe579c5待修R1～R4，不改产品，无视觉）
- [内容合同补测Codex复核](content-contracts-review.md)（实际fixture与六条漏检见证、负控判据、逐族账和交付卫生；未集成）
