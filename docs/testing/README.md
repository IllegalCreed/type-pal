...
- [共享战斗模拟器首批](../ops/tasks/EDITOR-SKILL-TRIAL-1-isolated-battle.md)与[原技能入口前提探针](skill-trial-premise.mjs)（fe0fee84三席准入已核通过，交用户UI验收；d394eccc列宽4文件待两席增量确认，可并行；我方1～3/敌方五槽）
