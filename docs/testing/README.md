...
- [Grok一阶段菜单与索引渲染十组候选回归](grok-present-regressions/README.md)与[Codex独立接收](grok-present-review.md)（TEST-GROK-PRESENT-1，候选23项/三针已复跑；输入快照与P06可达性仍counter，不合main、不计官方覆盖率）
