...
- [Cursor覆盖率说明定点核对回执槽](cursor-coverage-guide-audit.md)与[Codex独立接收/正式修订](cursor-coverage-guide-review.md)（DOC-CURSOR-3，Cursor候选b5e2ca4a材料accept但未合main；Codex只修当前入口文案，历史数字/基线不改，卡保持draft）
