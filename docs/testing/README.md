...
- [GLM十二组可执行架构回归实验包](glm-architecture-regression-lab/README.md)、[Codex首轮接收](architecture-regression-lab-codex-review.md)、[二轮接收](architecture-regression-lab-codex-r2-review.md)、[三轮接收](architecture-regression-lab-codex-r3-review.md)、[四轮接收](architecture-regression-lab-codex-r4-review.md)、[五轮接收](architecture-regression-lab-codex-r5-review.md)、[六轮接收](architecture-regression-lab-codex-r6-review.md)与[七轮接收](architecture-regression-lab-codex-r7-review.md)（r7 有真实测试增量、32候选绿，但 Biome 与 G03/G05 合同未闭；不进正式统计）
