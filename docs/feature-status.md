...
| L2 | 蛊虫 / 练蛊皿系统 | ✅ claimed | ✅ partial | script.c 0x66/0x28/0x20 | battle-opcodes.ts + event-system.ts | **opcode 全实现 + 脚本 byte 核验(2026-06-02)**:蛊 throwable→战斗投掷 0x66(:82)+0x28 apply-poison(:88)附身;炼蛊皿 scriptOnUse @39598=`0x20[117,1,...]`(RemoveItem,event-system:105)+goto 链。**byte-truth 订正**:蛊 item scriptOnUse 是**简单消耗品**(金蚕蛊@39451=0x5d JumpIfNotPoisonKind+0x2b CurePoisonKind;灵蛊@39524=0x1c IncreaseMP),**无"N回合升级"特殊机制**(user 描述的升级链 = 投掷/炼蛊皿组合,非定时升级)。残:真档 e2e 玩法验收(user 实玩)+ 物品框 dialog 视觉 |
