...
> 依据:[editor-design.md](../designs/editor-design.md)(§4 命令/undo · §11 布局)· [editor-b0-plan.md](editor-b0-plan.md)(B0 的 `EditSession`/`Command`/`MoveEntityCommand` 已在,照那套)。先读 [READ-FIRST](../../READ-FIRST.md)。
