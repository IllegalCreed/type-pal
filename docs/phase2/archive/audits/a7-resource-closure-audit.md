...
> 当前项目收敛为 catalog-only；资源闭包阶段切到 content19，场景目录阶段继续切到当前 content20：PAL 1,934 条记录，effect sprite 56 文件 / 652,870 B / 922 帧；
...
> 前置: [第二阶段开工铁律](../../READ-FIRST.md)、[项目生命周期设计](../designs/project-lifecycle-design.md)、[路线图 §10](../../roadmap.md)、[既有资产/迁移八单元审计](am-asset-migrate-audit.md)。
...
[项目生命周期设计](../designs/project-lifecycle-design.md) 已明确:一个工程文件夹包含该工程拥有的全部内容与素材,
...
- [project-design.md](../designs/project-design.md) 的早期边界是现行真值；生命周期文档中“全部资源”的
...
- Codex、Opus、GLM 三方最终均签 `accept`；Opus 独立复验冷缓存挂帧、OPFS 真句柄读写与 900×720 窄视口，
  ...
  [`A7-1 任务卡`](../../../ops/archive/tasks/done/A7-1-sfx-asset-closure.md)。
...
[`A7-2 任务卡`](../../../ops/archive/tasks/done/A7-2-static-images-engine-chrome.md)。
...
实现与完整验证矩阵见
[`A7-3T 任务卡`](../../../ops/archive/tasks/done/A7-3T-tileset-asset-closure.md)。A7-3T 已完成三方 `accept` 与用户验收；
...
[`A7-3W 任务卡`](../../../ops/archive/tasks/done/A7-3W-world-sprite-asset-closure.md)。A7-3W 单族已 done，不能据此宣称
A7/R7 总体完成。
...
[`A7-3B 任务卡`](../../../ops/archive/tasks/done/A7-3B-battle-sprite-asset-closure.md) 为准。正式签字前不标 done，
