...
> **现行结果（2026-09-06 复核）**：本文主体保留资产管线的历史演进证据。当前产品格式为
> contentVersion 20 / SAVE 8（2026-09-05 起含 SceneIndex；正文出现的旧版本号均为当时快照），`manifest.assets` 已 catalog-only；PAL 共 1,934 个 catalog 记录，新增的
...
实现与验证见
[`A7-3-cutscene-asset-workbench.md`](../../../ops/archive/tasks/done/A7-3-cutscene-asset-workbench.md)。
...
完整生命周期与 review 门禁见
[`A7-3T 任务卡`](../../../ops/archive/tasks/done/A7-3T-tileset-asset-closure.md)。
