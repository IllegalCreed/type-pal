...
> 当前规范见 [工程与工作区生命周期](../../specs/project-lifecycle.md)。旧状态、版本与签字按当时语境阅读。
...
[`a7-0-music-resource-closure-report.md`](../audits/a7-0-music-resource-closure-report.md)。A7 总体仍未闭包，
