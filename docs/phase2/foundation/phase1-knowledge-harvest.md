...
| [战斗 (B)](#b-战斗) | core/battle、present/battle | 极高(257 commit/143 fix) | ✅ 见 [battle-audit](../battle-presentation-audit-2026-07-05.md) |
...
### W6. SW 预缓存 5 坑
> 详见 [X · 元层 SW 段](#sw-预缓存5-坑)与 [A-4](#a-4-sw-预缓存与生产-cdn)。reforge 引擎层无 SW，属壳层/部署关注点。
...
> 已有专项审计：[battle-presentation-audit-2026-07-05.md](../battle-presentation-audit-2026-07-05.md)。
...
### SW 预缓存（5 坑）
> 详见 [A-4](#a-4-sw-预缓存与生产-cdn)。reforge 引擎层无 SW，属壳层。
