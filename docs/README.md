...
| 目录 | 阶段 / 内容 | 状态 |
|---|---|---|
| **[phase1/](phase1/README.md)** | 第一阶段 · **忠实还原**(v1.0.0)——真值表 / 设计 / 工程经验 / 历史计划归档 | 接近尾声 |
| **[phase2/](phase2/README.md)** | 第二阶段 · **重制引擎 + 编辑器 + 内容** | 进行中 |
| **[phase3/](phase3/README.md)** | 第三阶段 · **MMO + 深度玩法** | 远期设想 |
| **[lore/](lore/README.md)** | **世界观设定**(跨阶段:角色 / 阵营 / 时间线 / 禁忌 / DLC 设想) | 滚动 |
| **[ops/](ops/agent-workflow.md)** | **多 Agent 协作工作流**(看板 / 任务卡 / 三方共识关卡) | 执行规范 |
