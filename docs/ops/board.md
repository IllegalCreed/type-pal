...
| TEST-CURSOR-TOOLS-1 | [八组工具纯函数候选回归](tasks/TEST-CURSOR-TOOLS-1-pure-regressions.md) | draft | Cursor窄返工 / Codex接收 | 02d91f7a counter CT-R1/R2；21/20绿但路径错误预期/实际实参保真待修，T06复用；工具缺陷归Codex |
