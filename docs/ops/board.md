...
| TEST-EDITOR-IMPORT-CODEC-1 | [导入编码线程与视频元数据补测](tasks/TEST-EDITOR-IMPORT-CODEC-1-workers-metadata.md) | build | GLM已交付 / 待Codex接收 | r2三签齐无counter；PNG失败泄漏仍归Codex；有槽且目标未漂移按卡授权开工，不重签 |
