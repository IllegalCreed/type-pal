...
|---|---|---|---|---|
| N3-1 | 结构化控制流、实体具名行为与内部脚本退役 | build | R13-6C 先实现（Codex），再 R13-6D；Kimi C1-C4 / GLM S2、Kimi D1-D4 / GLM D2 为验收钉 | 6C/6D 三方设计 agree 齐（2026-08-05），合并裁定=分开、6C→6D；dry-run `open sites=0 / observations=4` |
