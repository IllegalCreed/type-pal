...
|---|---|---|---|---|
| EDITOR-SKILL-TRIAL-1 | [试放方案调整：共享战斗模拟器](tasks/EDITOR-SKILL-TRIAL-1-isolated-battle.md) | rework | Codex已备r2首批草案与交互草图，待产品确认 | 四目录/工程内配置/隔离真实战斗；UI与保存选择未答、r2签字未开，产品零改；GLM返工独立推进 |
