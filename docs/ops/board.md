...
|---|---|---|---|---|
| N3-1 | 结构化控制流、实体具名行为与内部脚本退役 | build | Codex 继续关闭 R13-Z source debt；归零后跑最终 runtime/save/browser/remigration 门禁 | append-only R13-Z authority 与 CLI 已接入但未发布；真实 dry-run fail-closed 于 open `4,947 sites / 4,489 observations`，无写盘；N3-1/C8/ED-5I 仍未完成 |
