...
|---|---|---|---|---|
| TEST-BATTLE-WORKFLOWS-1 | [战斗会话完整流程补测](tasks/TEST-BATTLE-WORKFLOWS-1-session-flows.md) | rework | GLM r3候选已交付，待Codex独立重新接收 | C1～C4一次闭合：39/272/1453、6+10负控全detected；旧反证不重开；不跑并集、不转Kimi |
