...
| SAVE-PREFLIGHT-1 | 当前存档预检与恢复失败隔离 | review | Codex：复核第二轮返工候选；通过后 Kimi 终审 | [任务卡](tasks/SAVE-PREFLIGHT-1-current-save-restore-preflight.md)；R4 像素宽度 + R2 normalize 测试已修，r1 不重签，不得标 done。 |
