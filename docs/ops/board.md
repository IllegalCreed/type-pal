...
|---|---|---|---|---|
| A7-0A | 标题菜单音乐角色与删除保护 | review | Opus 实现/听觉主审，随后 GLM 覆盖终审 | 第五角色、旧 v3 补齐、菜单清账生命周期已落地；全仓与 MG2 全绿，待两方 review 签字 |
| A7-3 | 视频与帧动画资源闭包及过场工作台 | draft | Opus 设计主审，随后 GLM 覆盖复核 | 左侧双列表、中间播放器/时间轴、右侧属性引用；视频/RNG 工程自包含，三签未齐不得 build |
