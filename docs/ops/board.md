...
|---|---|---|---|---|
| ARCH-CURRENT-ONLY-1 | 开发期单版本架构收口 | build | Codex：先补 KA2 characterization，再按 retention ledger 折叠 current-only 产品链 | B 已停线交接；G0 ledger 已落卡，V5 能力折叠为无版本 current author-script，不保留公开旧版入口 |
