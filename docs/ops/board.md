...
| ED-ADD-PICKER-DIALOG-1 | 编辑器候选对象添加弹窗统一 | blocked | Kimi + GLM 增量核 RecipeEditor 第 7 owner；4+7 三签齐前禁止继续实现 | 4 included + 7 deferred 待冻结；公共 WIP 保留、业务页尚未迁移，KA1-KA5 / AP1-AP3 继续有效 |
