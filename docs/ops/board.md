...
|---|---|---|---|---|
| N3-1 | 结构化控制流、实体具名行为与内部脚本退役 | rework | User：验收 `0d4aa48b` P7-R10；通过后交 GLM 合并终审 | 场景/实体同步与引用精确反跳已修复；通用编辑器和真实预览仍待用户整体验收 |
| C8 | 物品用途机制、运行时与迁移闭环 | review | GLM 补审 `88277465..0d4aa48b` editor delta；随后待 N3-1/用户联合验收 | 已达 100/0 与 20 件/21 根；Kimi 已 accept 最终候选，GLM 已 accept core、delta pending |
