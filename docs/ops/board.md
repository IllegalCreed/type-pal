...
| B10-1 | 混乱敌人攻击同伴 | build | 三方 design agree 满签；Codex 唯一 Coding Owner 实现，完成后交 Kimi / GLM review | v11 immutable → v12 append-only；固定 5 槽、动态 wMaxEnemyIndex、G1-G4 + K1-K5 build 钉 |
