...
|---|---|---|---|---|
| N3-1 | 结构化控制流、实体具名行为与内部脚本退役 | build | Kimi / GLM 复审 R13-5 `e6a521d6..299a6fb8` | 两项 post-publication counter 已返工，fast/release 证明已拆分且根门全绿；仍待 Kimi/GLM 对新基线改签 accept，R13-6/R13-Z 未开始 |
