...
|---|---|---|---|---|
| N3-1 | 结构化控制流、实体具名行为与内部脚本退役 | build | Codex 继续处理 Kimi F1–F4 counter；等待 Kimi 定向复审 | GLM 已接受 F5 返工：P0/P2 不重冻，canary 2/2（256.03s / RSS 1.58GB）；Kimi counter 未关闭，R13-Z 未开始 |
