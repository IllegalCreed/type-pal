...
| ED-ACTION-GROUP-ADOPTION-3 | 地图与组合库图层动作组及窄栏合同 | done | `44c0cfd5` 三方 accept + 用户验收齐，整卡收口 | 三组+320/216换轨；1534全绿，DS2.23.0与13/44/22/22/11闭合 |
| ED-SPRITE-ACTION-MODAL-1 | 大世界精灵预制动作中心弹窗编辑器 | draft | RESTORE-1/ADOPTION-3依赖已done；用户形态与三方design签字齐，可转build | 中央Hero+单一Dialog+源帧区+搜索listbox；目标DS2.24与action15/42/24/18/9、reorder17/27/30/19 |
