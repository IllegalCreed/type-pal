...
|---|---|---|---|---|
| EDITOR-SCENE-REF-GUARD-1 | [场景删除引用保护](tasks/EDITOR-SCENE-REF-GUARD-1-scene-deletion-reference-closure.md) | review | Kimi/GLM并行终审 | 单adapter修复、22新回归/PAL补1边、最小界面验证通过；check7442/受保护fast6954绿，Codex accept |
| TEST-REFORGE-RUNTIME-CONTRACTS-1 | [运行时基础功能五组补测](tasks/TEST-REFORGE-RUNTIME-CONTRACTS-1-runtime-boundaries.md) | build | GLM连续实施 / Codex后续接收 | 6300223a本人核三席设计准入；五组十模块30族非视觉测试，生产冻结3bc20273，与Codex修复隔离 |
