...
| ED-SPRITE-ACTION-MODAL-1 | 大世界精灵预制动作中心弹窗编辑器 | done | `f8420026` 三方 accept + 用户验收齐，整卡收口 | 中央单一Dialog、共享源帧、create/edit事务与DS2.24闭合；1556项、build、DS gate和四档浏览器矩阵通过 |
...
| ED-WORKSPACE-ADOPTION-DEBT-1 | 编辑器旧工作区滚动壳真实采用清零 | review | `39ea04cd` Codex + Kimi accept；待GLM终审与用户验收 | 六文件22 raw/legacy全零；27 pages全adopted；1562项+三档九route实机通过 |
