...
|---|---|---|---|---|
| TEST-BATTLE-WORKFLOWS-1 | [战斗会话完整流程补测](tasks/TEST-BATTLE-WORKFLOWS-1-session-flows.md) | rework | Codex已接收fd4efd76，待统一集成/阶段推进 | 46/1460、本席accept无counter；用户已豁免Kimi本次终审；整仓门禁/并集未跑，不done |
