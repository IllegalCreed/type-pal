...
|---|---|---|---|---|
| EDITOR-SCENE-REF-GUARD-1 | [场景删除引用保护](tasks/EDITOR-SCENE-REF-GUARD-1-scene-deletion-reference-closure.md) | build | Codex实现/自验 | r1三席设计齐、无counter，948e0328核准入；三漏边+去重/冷暖/删除恢复回归，GLM测试面不动 |
