...
| ED-PROJECT-STARTUP-IA-1 | 入口与开局 / 全局资源与启动工作台收口 | review | Kimi + GLM 复审本轮返工；双 accept 后用户验收 | 成员行合并、原子清 seed、orphan 三态 repair、DS v2.11.0 density 门禁均已实现；Editor 1209 全绿 |
