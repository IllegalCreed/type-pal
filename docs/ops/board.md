...
| OPS-TST-PERF | 迁移测试 fixture 分层与冷启动性能债 | rework | Codex 补 G1/G2 映射、G7 顺序探针并继续降低 G8 峰值 | R13-6A 改父报告窄增量后 strict canary 2/2 为 271.87s、RSS 2.86GB且原 golden 不变；source-semantics release 11/11，G7/RSS/三次冷跑仍阻塞 |
