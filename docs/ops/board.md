...
|---|---|---|---|---|
| TEST-BATTLE-WORKFLOWS-1 | [战斗会话完整流程补测](tasks/TEST-BATTLE-WORKFLOWS-1-session-flows.md) | rework | Codex已接收fd4efd76，待统一集成/阶段推进 | 46/1460、消费门反证闭合；本席accept无counter；Kimi额度尽待终审，无豁免；并集未跑 |
