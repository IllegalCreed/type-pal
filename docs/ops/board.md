...
| ED-REORDER-SURFACE-1 | 编辑器排序项可见边界与列表表面合同 | review | Codex accept；待 Kimi/GLM 当前实现终审与用户验收，签字不足不得 done | 29 双轴=10 repeat+12 object+2 edge+5 continuous；六红项与 32px 动作组闭合 |
