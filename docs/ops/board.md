...
| SAVE-PREFLIGHT-1 | 当前存档预检与恢复失败隔离 | rework | GLM：直接修复 R1–R4；随后 Codex 复核 | [任务卡](tasks/SAVE-PREFLIGHT-1-current-save-restore-preflight.md)；无需 Kimi 再确认阻断，修复经 Codex 通过后才终审，r1 不重签。 |
