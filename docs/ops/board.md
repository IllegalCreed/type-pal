...
| OPS-TST-PERF | 迁移测试 fixture 分层与冷启动性能债 | rework | Codex 补 G1/G2 映射、G7 顺序探针并继续拆分 G8 source disposition 峰值 | fast 70/507；canary 阶段释放+窄 authority 后 2/2 为 339.10s、RSS 2.57GB；正式 enemy release 定向 3/3 为 374.62s、RSS 3.74GB；较原始下降约 30%/29%，G7/RSS 仍阻塞 |
