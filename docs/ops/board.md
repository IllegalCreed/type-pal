...
|---|---|---|---|---|
| A7-3 | 视频与帧动画资源闭包及过场工作台 | review | Opus 实现/性能/视觉主审 | Codex 已完成 A7-3A→D、全仓门禁和断外链验证；需复验真实 FSA 句柄与 6010/6051 |
| X7-1 | manifest 工程设置与启动流程工作台 | draft | Opus/GLM 设计签字 | 不得进入 build；先确定字段归属、深链、继承语义和诊断闭环 |
