...
| OPS-TST-PERF | 迁移测试 fixture 分层与冷启动性能债 | rework | Codex 补 G1/G2 映射、G7 顺序探针并处理 G8 RSS 裁决 | synthetic trust-boundary 已补至 6/6；fast 70/506，release 92/635；canary 2/2 为 484.72s、RSS 3.63GB，G7/RSS 仍阻塞 |
