...
|---|---|---|---|---|
| EDITOR-SKILL-TRIAL-1 | [试放方案调整：共享战斗模拟器](tasks/EDITOR-SKILL-TRIAL-1-isolated-battle.md) | rework | Codex：草图大方向已获认可，待保存选择 | r2首批草案已备；图示非完整功能，本场调整不限技能；保存两项待答、r2签字未开，产品零改 |
