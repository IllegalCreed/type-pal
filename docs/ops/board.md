...
| ED-ITEM-ALCHEMY-SURFACE-1 | 炼蛊皿与紫金葫芦双炼化工作台 | blocked | 等 MIG-PAL-CRAFT-FAILURE-MESSAGE-1 三方终审后复验 | UI 已实现；producer 修复已重迁并视觉通过，旧 Codex counter 待 migration done 后重签 |
