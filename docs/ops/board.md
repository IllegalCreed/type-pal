...
|---|---|---|---|---|
| N3-1 | 结构化控制流、实体具名行为与内部脚本退役 | build | R13-6C 实现+自验完成（证据+seal/rewind），待三方实现审查；下一步 R13-6D oracle | `--r13-6c` dry-run `open sites=0 / observations=1`；6C 单测 3/3、fast 78/570 绿 |
