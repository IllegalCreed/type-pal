...
| TEST-COVERAGE-DETERMINISM-1 | 编辑器覆盖率计数确定性 | build | GLM：按 r1 白名单补单条确定性回归 | [任务卡](tasks/TEST-COVERAGE-DETERMINISM-1-editor-ratchet.md)；三席前提/设计签字齐，Codex 已放行；只改测试及生成基线，随后 Codex 复核。 |
