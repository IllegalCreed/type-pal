...
| ED-ADD-PICKER-DIALOG-1 | 编辑器候选对象添加弹窗统一 | build | 4+6 三签齐，Codex 恢复唯一 Coding Owner；先修公共反例再迁移四个 included surface | 4 included + 6 deferred 已冻结；KA1-KA5 / AP1-AP3 继续有效 |
