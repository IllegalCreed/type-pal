...
| ED-ACTION-GROUP-SPEC-1 | DsActionGroup 公共规范与当前采用闭合 | review | `1c320ce0` Codex + Kimi accept；待 GLM 终审 + 用户验收 | DS 2.22.0；8/46/16/30/15；1 equivalent +14 deferred；单枚与1→3均必红 |
