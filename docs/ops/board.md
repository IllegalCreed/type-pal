...
| ED-ITEM-ALCHEMY-SURFACE-1 | 炼蛊皿与紫金葫芦双炼化工作台 | review | `314e88e3` + `55b5e981` + `35843eb7` + `c8016faa` Codex accept；待增量终审/复验 | 数量/对称SVG/Shop式edge列表；宽屏可见间距15px/15px，91 tests/typecheck/DS绿 |
