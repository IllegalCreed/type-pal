...
|---|---|---|---|---|
| EDITOR-SCENE-REF-GUARD-1 | [场景删除引用保护](tasks/EDITOR-SCENE-REF-GUARD-1-scene-deletion-reference-closure.md) | draft | Codex修复 / Kimi、GLM并行审r1 | D-02三漏边在最新主线复现，40相邻绿；仅editor adapter，设计未齐不实现 |
| TEST-REFORGE-RUNTIME-CONTRACTS-1 | [运行时基础功能五组补测](tasks/TEST-REFORGE-RUNTIME-CONTRACTS-1-runtime-boundaries.md) | draft | GLM整包 / Kimi并行审r1 | 五组十模块30族、只增非视觉测试；生产冻结3bc20273，与Codex修复隔离 |
