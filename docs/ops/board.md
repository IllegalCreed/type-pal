...
|---|---|---|---|---|
| EDITOR-SKILL-TRIAL-1 | [共享战斗模拟器首批](tasks/EDITOR-SKILL-TRIAL-1-isolated-battle.md) | review | Kimi / GLM 并行终审 | cb44c378；check7891/strict7400/build通过，已处理图标/动态列/技能多选；保存原生选择器取消限制已披露，不标done |
