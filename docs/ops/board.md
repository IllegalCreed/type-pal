...
| ED-FRAME-TIMELINE-UX-RESTORE-1 | 帧动画原始卡片拖拽形态恢复 | review | 用户豁免Kimi/GLM三签；Codex自验accept，待用户验收 | 72×76/78/86/visible/native drag已恢复；1523全绿，三档真实页面通过 |
| ED-ACTION-GROUP-ADOPTION-3 | 地图与组合库图层动作组及窄栏合同 | draft | 依赖RESTORE-1；用户批准保留图层拖拽/移动；Codex + Kimi 已签，待 GLM 签字与三组/320/216 形态裁决 | 0-move registry真模型；目标DS2.23.0与13/44/22/22/11 |
| ED-SPRITE-ACTION-MODAL-1 | 大世界精灵预制动作中心弹窗编辑器 | draft | 依赖RESTORE-1/ADOPTION-3；用户形态批准；Codex + Kimi 已签，待 GLM 设计签字 | 中央Hero+单一Dialog+源帧区+搜索listbox；目标DS2.24与action15/42/24/18/9、reorder17/27/30/19 |
