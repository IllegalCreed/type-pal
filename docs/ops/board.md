...
|---|---|---|---|---|
| TEST-BATTLE-WORKFLOWS-1 | [战斗会话完整流程补测](tasks/TEST-BATTLE-WORKFLOWS-1-session-flows.md) | rework | GLM r4候选已交付，待Codex独立重新接收 | N1～N4一次闭合：45/278/1459、6+10负控、四变异自检红；已关闭项不重开；不跑并集 |
