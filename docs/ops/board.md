...
|---|---|---|---|---|
| EDITOR-SKILL-TRIAL-1 | [共享战斗模拟器首批](tasks/EDITOR-SKILL-TRIAL-1-isolated-battle.md) | review | Kimi / GLM：UI-r1增量复核 | fe0fee84：候选弹窗、短控件/自适应列、间距与临时覆盖确认；check7895/strict7404通过，旧机制签字保留，不标done |
