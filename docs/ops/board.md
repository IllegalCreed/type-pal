...
| OPS-TST-PERF | 迁移测试 fixture 分层与冷启动性能债 | rework | Kimi/GLM 复核 G8；Codex 后续补 G1 映射与 G7 顺序探针 | G8 三次真冷 canary wall max 562.46s、RSS max 1.478GB，已达门槛；fast 71/533 为 39.38s，G1/G7 仍阻塞 |
