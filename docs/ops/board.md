...
| M3 | 迁移脚本去内联、按场景分片与体积门禁 | **review** | Opus 代码/架构复验 | Codex 实现与自测完成：294 chunk，体积 1.63x/1.05x/1.57x，双跑哈希一致，pnpm check 3368 tests、非脚本字段差异 0、6051 行为验证通过；待 Opus→GLM 审查签字。任务卡:[M3-wander-arm-explosion.md](tasks/M3-wander-arm-explosion.md) |
