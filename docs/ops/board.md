...
| ED-ACTION-GROUP-ADOPTION-1 | 同项动作组采用第一批（战斗 / 毒回合；项目设置 / 入口点） | rework | refreshed 三方签字齐（签字面 allowed，280 形态用户已批）；Codex 可恢复实现 | 入口235px正文53px推翻旧前提；新方案>=280同排/<280动作下沉；目标10/46/20/26/13 |
