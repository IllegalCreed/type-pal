...
|---|---|---|---|---|
| TEST-GROK-PRESENT-1 | [一阶段菜单/渲染十组候选回归](tasks/TEST-GROK-PRESENT-1-phase1-menu-regressions.md) | draft | Grok仅修C1a / Codex独立接收 | r2候选24/24、三针绿红对照与P06均核；实参 catalog 数组与快照不同对象，不合main/不计官方覆盖率 |
| TEST-CURSOR-TOOLS-1 | [八组工具纯函数候选回归](tasks/TEST-CURSOR-TOOLS-1-pure-regressions.md) | draft | Codex / 后续正式准入 | 85f2a824隔离材料accept，22绿+诊断1绿1红、反控闭合；工具缺陷待修，不合main/不标done |
