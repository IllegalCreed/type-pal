...
|---|---|---|---|---|
| N3-1 | 结构化控制流、实体具名行为与内部脚本退役 | build | Kimi / GLM 独立审 R13-5 formal candidate | R13-5 子批已进入 review：content10、12/31 debt 归零、8-file formal write、内部 replay + live dry-run 均 0/0/0；Codex=accept，待 Kimi/GLM accept，R13-6/R13-Z 未开始 |
