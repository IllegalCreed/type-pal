...
|---|---|---|---|---|
| TEST-CONTENT-CONTRACTS-1 | [内容数据校验与引用边界补测](tasks/TEST-CONTENT-CONTRACTS-1-content-validation-boundaries.md) | rework | GLM修R1～R4 / Codex复核 | dbe579c5 counter；116/673及覆盖增量成立，fixture/六漏检/判据/完成账需修，设计不重签 |
