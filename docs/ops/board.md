...
| ED-SPRITE-ACTION-MODAL-1 | 大世界精灵预制动作中心弹窗编辑器 | review | `f8420026` 三方 accept 齐；待用户验收（建议顺带真 Chrome 确认 create 初焦点） | 实现 f8420026；串行1556项、build、DS gate与四档浏览器矩阵通过；真实200%/Firefox/WebKit待补验 |
