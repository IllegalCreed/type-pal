...
|---|---|---|---|---|
| DOC-CURSOR-2 | [十二组包说明/CLI/索引核对](tasks/DOC-CURSOR-2-package-tools-indexes.md) | draft | Cursor回执窄返工 / Codex接收 | 3852afe5/e3da44ca counter R1～R4；白名单/资源hash过，误报/替换句/锚点及分类待修，不合main |
