...
|---|---|---|---|---|
| MIG-PAL-INPARTY-ID-1 | [PAL 四条队伍角色条件稳定 ID 修复](tasks/MIG-PAL-INPARTY-ID-1-pal-actor-condition-ids.md) | draft | GLM 设计审查（Kimi 已签） | current/baseline 各 3 scene/4 values；只修上游，不得手改产物 |
