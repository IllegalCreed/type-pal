...
|---|---|---|---|---|
| TEST-GROK-PRESENT-1 | [一阶段菜单/渲染十组候选回归](tasks/TEST-GROK-PRESENT-1-phase1-menu-regressions.md) | draft | Codex决定正式接入与统一门禁 | r3候选503a2d24材料accept；23绘制+2快照自测，三针可鉴别；未合main/不计官方覆盖率 |
