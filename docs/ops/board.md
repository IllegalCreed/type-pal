...
| MIG-PAL-GOURD-FAILURE-MESSAGE-1 | PAL 紫金葫芦零灵葫值原文迁移闭环 | build | Codex 唯一 Coding Owner；strict pool → ownership/invariant → 重迁 | 三签与两依赖齐；KG1~KG6 + GM-D1~D4 收敛，无 counter |
