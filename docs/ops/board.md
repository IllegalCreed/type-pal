...
| TEST-RESOURCE-TOOLS-COVERAGE-1 | [RLE、事件与资源工具补测](tasks/TEST-RESOURCE-TOOLS-COVERAGE-1-rle-events-font.md) | build | GLM已交付 / 待Codex接收 | r1三签齐；用户拍板额度空窗期先行实施；24项+9针+覆盖已交付 |
