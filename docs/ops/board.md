...
| ED-ITEM-ALCHEMY-SURFACE-1 | 炼蛊皿与紫金葫芦双炼化工作台 | review | Codex `54ba9c2e` + `1b090cb2` + `aacf68b7` accept；待 Kimi/GLM 与用户验收 | 双单一机制、自动取材/实际扣除、固定资源 readout、Enemy 来源与 29/32 registry 已实现 |
