...
- `docs/ops/archive/tasks/done/ED-ACTION-GROUP-ADOPTION-1-editor-action-group-adoption-batch-1.md`
- `docs/phase2/specs/editor-design-system.md` DS-C.2a / DS-C.4d
