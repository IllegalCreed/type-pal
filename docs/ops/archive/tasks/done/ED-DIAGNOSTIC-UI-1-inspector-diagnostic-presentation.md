...
- 已知坑 / 审计文档：
  - `docs/phase2/specs/editor-design-system.md:379-413`：Reference count/impact/action 是引用专用合同。
  - `docs/phase2/specs/editor-design-system.md:415-427`：错误与诊断必须保留上下文，并按全局/字段/短暂反馈分层。
...
任务卡: docs/ops/archive/tasks/done/ED-DIAGNOSTIC-UI-1-inspector-diagnostic-presentation.md
