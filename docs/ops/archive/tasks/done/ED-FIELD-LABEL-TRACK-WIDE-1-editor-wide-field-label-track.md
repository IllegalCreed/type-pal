...
| 当前二阶段 | DS-F / DS-L.7 锁定唯一 96px 主轨，长标签整组 stacked，禁止业务页扩宽；静态门禁拒绝业务 `--ds-field-label-track` 与私有 grid。 | `docs/phase2/specs/editor-design-system.md:201-202,353-360`；`packages/editor/src/ui/design-system/field-layout-adoption.test.ts:2282-2322,2434-2520` |
...
- `docs/ops/archive/tasks/done/ED-FIELD-LAYOUT-1-editor-field-label-layout-contract.md`：既有 96px/480px 合同与禁止私有轨。
