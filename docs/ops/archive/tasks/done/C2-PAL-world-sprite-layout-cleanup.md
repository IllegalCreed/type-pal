...
- 已拍板决策 / 铁律:
  ...
  - `docs/ops/archive/tasks/done/A7-3W-world-sprite-asset-closure.md:101-116`：13 条布局债被明确保留并排除出 A7-3W，不得拿旧卡签字冒领本清洗。
...
任务卡: docs/ops/archive/tasks/done/C2-PAL-world-sprite-layout-cleanup.md
...
先读: AGENTS.md、docs/phase2/READ-FIRST.md、本任务卡、docs/ops/archive/tasks/done/A7-3W-world-sprite-asset-closure.md:101-116、docs/phase2/capability-map.md:82
...
先读: AGENTS.md、docs/phase2/READ-FIRST.md、本任务卡、docs/ops/archive/tasks/done/A7-3W-world-sprite-asset-closure.md:101-116、packages/migrate/src/pal-world-sprite-layouts.ts、pal-world-sprite-layouts.test.ts、pal-migration-integration.test.ts
