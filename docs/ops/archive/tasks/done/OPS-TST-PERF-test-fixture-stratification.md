...
逐条旧标题到后继证明的 44 条闭环见
[`docs/ops/archive/audits/OPS-TST-PERF-g1-coverage-map.md`](../../audits/OPS-TST-PERF-g1-coverage-map.md)。
...
- 2026-08-03 Codex: G1 逐条映射落盘至 `docs/ops/archive/audits/OPS-TST-PERF-g1-coverage-map.md`，固定 44 条旧
...
- 2026-08-03 Kimi: G1/G7 复审签 **accept（G1+G7+G8）**。一手证据：
  - **G1**：44 条映射表（docs/ops/archive/audits/OPS-TST-PERF-g1-coverage-map.md）逐条核对，抽查
...
- 2026-08-03 GLM G1/G7 复核（`f00b2124`）：签 **accept**。一手核实（代码 + 映射文档 + 实跑）：
  - **G1 逐项映射**（`docs/ops/archive/audits/OPS-TST-PERF-g1-coverage-map.md`）：44 条逐项，每条保留
