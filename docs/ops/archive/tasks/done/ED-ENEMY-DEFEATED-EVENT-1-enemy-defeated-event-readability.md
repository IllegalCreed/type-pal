...
- `ED-ENEMY-1` 的冻结设计曾要求高级演出进入脚本编辑：
  `docs/ops/archive/tasks/done/ED-ENEMY-1-enemy-team-reward-authoring-closure.md:78-84,302-303`。
...
- `docs/ops/archive/tasks/done/ED-ENEMY-1-enemy-team-reward-authoring-closure.md`（只继承敌人 / 敌队单一权威，不重开 done 卡）
