...
- Codex 核查:用户记忆正确。`docs/phase2/decisions.md` D16 和 `docs/phase2/archive/designs/content-schema.md` §5 明确写新地图模型应是 **N 个视觉层 + 独立碰撞 / 地形层**;旧 `cell.lower/upper` + word 位域只是旧 Tilemap 兼容层。
...
任务卡: docs/ops/archive/tasks/done/W7C-3-dual-layer-collision-brush.md
...
先读: AGENTS.md 的三贤人协议;本任务卡的“范围澄清 / 用户质疑”“上下文锚点”“验证”“推进签字”“Build”“Review”段;docs/phase2/decisions.md D16;docs/phase2/archive/designs/content-schema.md §5。子格模型已考证钉死,勿再考证。
