...
- 已知坑 / 审计文档:
  - `docs/phase2/archive/designs/editor-design.md:210-235` 固化了旧伪入口 / 继承设计，必须由本卡显式 supersede。
...
- 文档:
  - 更新 `docs/phase2/archive/designs/editor-design.md` 的 X7-1，明确真实入口、直接启动 selector 和一次性复制。
...
任务卡: docs/ops/archive/tasks/done/ARCH-ENTRYPOINT-CANONICAL-1-explicit-startup-entry-model.md
...
先读: 本任务卡全文（重点: 验收条件、Kimi 审查签字逐条证据、GE1-GE4 落钉要求）；
  ...
  packages/editor/src/core/seed.ts 与其测试；docs/phase2/archive/designs/editor-design.md:210-235；
