...
| 本任务目标 | 用一个显式 SceneIndex 同时持有稳定 id、作者名称和文件路径；SceneDef 继续只持运行/内容真值。生命周期动作通过现有 `EditorHistoryCoordinator` 成对提交，引用/删除复用 ED-3。 | 本卡范围；`packages/editor/src/core/editor-history-coordinator.ts:13-88`; `docs/ops/archive/tasks/done/ED-3-project-reference-index.md` |
...
- 已知坑 / 审计文档:
  - `docs/phase2/archive/audits/editor-authoring-closure-audit-2026-07-13.md:102-133,221-247`
  - `docs/ops/archive/tasks/done/ED-3-project-reference-index.md`
...
> `docs/ops/archive/tasks/done/ED-SCENE-LIFECYCLE-1-scene-crud-and-safe-delete.md` 做进入 done 前的独立终审。
> 实现候选固定为 `f0e7b2b9`，任务状态为 `review`。不得修改实现文件、任务状态、看板或 done 准入结论；
> 不要读取或复述 GLM 的结论。
>
> 先完整阅读 `AGENTS.md`、`docs/phase2/READ-FIRST.md`、本任务卡、候选完整 diff、
> `docs/ops/archive/tasks/done/ED-3-project-reference-index.md`、content schema/editor/project/save 文档。必须直接读取
...
> 你是三贤人系统中的 Kimi。请对任务卡
> `docs/ops/archive/tasks/done/ED-SCENE-LIFECYCLE-1-scene-crud-and-safe-delete.md` 做进入 build 前的独立
...
> `docs/ops/archive/tasks/done/ED-3-project-reference-index.md`、`docs/phase2/roadmap.md`、
> `docs/phase2/archive/designs/content-schema.md`、`docs/phase2/archive/designs/project-design.md` 与
> `docs/phase2/archive/designs/editor-design.md`。然后必须直接读取并给出自己的 `file:line` 证据，至少核验：
...
> 先完整阅读 `AGENTS.md`、`docs/phase2/READ-FIRST.md`、本任务卡、
> `docs/ops/archive/tasks/done/ED-3-project-reference-index.md`、`docs/phase2/roadmap.md`、
> `projects/pal/e2e-checkpoints/README.md`、`docs/phase2/archive/designs/content-schema.md` 与
> `docs/phase2/archive/designs/project-design.md`。然后必须直接读取代码/工程并给出自己的 `file:line`、命令与计数
