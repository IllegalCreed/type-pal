...
- 已知坑 / 审计文档：
  - `docs/ops/archive/tasks/done/ED-FIELD-COMMIT-1-editor-field-draft-commit-boundary.md`
...
- 性能证据：`docs/ops/archive/evidence/ED-INPUT-PERF-1-pal-chromium-2026-08-25.md`（五字段各 20 个原始
...
任务卡：docs/ops/archive/tasks/done/ED-INPUT-PERF-1-editor-input-and-derived-state-latency.md
...
先读：AGENTS.md、CLAUDE.md、docs/phase2/READ-FIRST.md、本任务卡全文、
  docs/ops/archive/evidence/ED-INPUT-PERF-1-pal-chromium-2026-08-25.md；ED-FIELD-COMMIT-1 只作冻结历史合同。
...
docs/ops/archive/tasks/done/ED-FIELD-COMMIT-1-editor-field-draft-commit-boundary.md；再读任务卡列出的 App、diagnostics、projection、
