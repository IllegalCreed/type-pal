...
- 已知坑 / 审计文档:
  - `docs/phase2/design-backlog.md` 议题 16；`docs/phase2/archive/designs/actor-model-design.md` 的布局/姿势分层。
  - `docs/ops/archive/tasks/done/C2-PAL-world-sprite-layout-cleanup.md`：static 是默认定格布局，不代表物理资源只有一帧。
...
任务卡: docs/ops/archive/tasks/done/C2-ACT-sprite-action-playback.md
