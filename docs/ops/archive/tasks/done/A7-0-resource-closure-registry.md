...
- 已拍板决策 / 铁律:
  ...
  - `docs/phase2/archive/designs/project-lifecycle-design.md:18-35`:一个工程文件夹包含整个游戏的全部资源,克隆后零服务器依赖。
  - `docs/phase2/archive/designs/project-lifecycle-design.md:47-69`:内容与素材统一走 FileSource,blob URL 生命周期必须受管理。
...
- 已知坑 / 审计文档:
  - `docs/phase2/archive/audits/a7-resource-closure-audit.md`:本卡的完整现状证据、终态契约、旁路清单与分期。
  - `docs/phase2/archive/audits/am-asset-migrate-audit.md`:既有提取/解码/资产管线审计；A7 不重写 MKF/RLE 真值。
...
- Codex: **accept（2026-07-15）**。完成实现、自测、迁移重生成、静态扫描、6010 音乐页与 6051
  ...
  `docs/phase2/archive/audits/a7-0-music-resource-closure-report.md`。
...
- 2026-07-15 Codex: 完成 A7/R7 现状审计、终态契约、分期和 A7-0 任务卡；Codex 设计签 agree。
  Evidence: `docs/phase2/archive/audits/a7-resource-closure-audit.md`；当前只改文档。
