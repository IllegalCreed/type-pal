...
- 已发布 B10-1 parent：`docs/ops/archive/tasks/done/B10-1-enemy-confused-attack.md`、commit
...
`docs/ops/archive/tasks/done/B10-1-enemy-confused-attack.md`。任务卡当前 `Status=review`，设计三方本人 agree 已齐，
...
`docs/ops/archive/tasks/done/W9-entity-lifecycle-respawn.md` 的两条“用户验收返工”记录。重点检查：
...
`docs/ops/archive/tasks/done/W9-entity-lifecycle-respawn.md` 的两条“用户验收返工”记录和最新 Kimi 补审 accept。
