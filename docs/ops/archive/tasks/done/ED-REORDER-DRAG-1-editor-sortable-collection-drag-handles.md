...
- 已知坑 / 审计文档:
  - `docs/phase2/specs/editor-design-system.md:181-190,450-463`
  - `docs/phase2/archive/audits/editor-ui-audit-2026-08-15.md:155`
  - `docs/ops/archive/tasks/done/ED-DS-3-editor-design-system-adoption-gate.md`
  - `docs/ops/archive/tasks/done/ED-PROJECT-STARTUP-IA-1-project-entry-startup-workbench.md`
  - `docs/ops/archive/tasks/done/ED-CATALOG-ROW-IA-1-editor-catalog-row-information-hierarchy.md`
  - `docs/ops/archive/tasks/done/ARCH-ACTOR-CONDITION-SEED-1-entry-and-story-actor-conditions.md`
- 不得重新引入:
...
- 集中 E2E 用例 / 批次: N/A
- 截图 / 像素检查路径:
  - `docs/ops/archive/evidence/ED-REORDER-DRAG-1/design-lab-rf21-1280.png`
  - `docs/ops/archive/evidence/ED-REORDER-DRAG-1/pal-startup-party-720.png`
  - `docs/ops/archive/evidence/ED-REORDER-DRAG-1/design-lab-live-reflow-2026-08-27.png`
...
任务卡：docs/ops/archive/tasks/done/ED-REORDER-DRAG-1-editor-sortable-collection-drag-handles.md
