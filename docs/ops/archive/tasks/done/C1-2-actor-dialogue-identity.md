...
| 第一阶段 | 运行时忠实保存当前样式/立绘号和姓名文本状态，只解决原版显示/擦除语义，不建立作者侧人物身份。 | `docs/phase1/engineering-notes.md:114-117`; `docs/phase2/reference/phase1-knowledge-harvest.md:130-134,289-294` |
...
- 文档：`docs/phase2/READ-FIRST.md`; `docs/phase2/archive/designs/model-design.md`;
  `docs/phase2/reference/phase1-knowledge-harvest.md`; `docs/phase1/engineering-notes.md:114-117`;
...
任务卡: docs/ops/archive/tasks/done/C1-2-actor-dialogue-identity.md
