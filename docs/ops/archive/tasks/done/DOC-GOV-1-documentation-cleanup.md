...
package.json、工作流、docs/ops/guides/documentation.md、board.md、tasks/index.md 与产品代码。

### DOC-01（canonical 版本冲突）→ 已修

- `packages/migrate/README.md:3-5` → content20/SAVE8 + SceneIndex 来源与版本常量真源注记。
- `docs/phase2/archive/designs/asset-pipeline.md` 现行结果节 → 20，旧版本字样改为「旧版本号均为当时快照」（避免检查器字面量红）。
- `docs/phase2/archive/designs/script-system-design.md` → 头部 20；契约节标题去版本号。
- `docs/phase2/guides/shared-script-author-guide.md` → 适用版本 20 + 正文两处 19→20。
- `docs/phase2/archive/designs/editor-design.md:255`、`docs/phase2/archive/designs/project-lifecycle-design.md` §19 → 20 + 真源注记。
