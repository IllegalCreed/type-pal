...
- 已拍板决策 / 铁律:
  ...
  - `docs/phase2/archive/designs/e6-position-authority-design.md:41-72`：world / script / mount
    单写者矩阵；mount 位置由父实体派生。
  - `docs/phase2/archive/audits/n-event-script-audit.md:580-589`：mountParty / ride 已有语义。
...
Evidence: docs/phase2/archive/designs/e6-position-authority-design.md:41 / collision.ts:6-28(sameGrid/sameLatticeCell) /
...
`docs/ops/archive/tasks/done/D15-1-npc-movement-dynamic-collision.md` 当前 rework 实现做只读复审。先完整阅读
...
`docs/ops/archive/tasks/done/D15-1-npc-movement-dynamic-collision.md` 当前 rework 做只读覆盖审查。先完整阅读
