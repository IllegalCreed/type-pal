...
- 已拍板决策 / 铁律:
  ...
  - `docs/ops/archive/tasks/done/A7-0-resource-closure-registry.md`：音乐只经 catalog + AssetId + 封闭 roles；引用存在才允许删除保护。
...
- 已知坑 / 审计文档:
  - `docs/phase2/archive/audits/a7-resource-closure-audit.md:163-180,271-297` 当前报告把 13 个未引用曲目视为 warning，
