...
- 已拍板决策 / 铁律:
  ...
  - `docs/phase2/archive/audits/x-shell-audit.md:293`:D22 已定 RNG 迁移为真彩序列帧第一类资产，脚本使用稳定动画 id；
    全帧还是补丁必须以真实体积实测决定。
  - `docs/phase2/archive/audits/a7-resource-closure-audit.md:35-52,398-404`:工程资源必须自包含；RNG/视频归 A7-3，
...
- 已知坑 / 审计文档:
  - [`cutscene-asset-workbench-design.md`](../../../../phase2/archive/designs/cutscene-asset-workbench-design.md):完整数据模型、UI 和分期。
...
完整方案见 [`docs/phase2/archive/designs/cutscene-asset-workbench-design.md`](../../../../phase2/archive/designs/cutscene-asset-workbench-design.md)。
...
- 截图 / 像素检查路径:
  - `docs/ops/archive/evidence/A7-3/editor-frame-workbench-desktop.png`
  - `docs/ops/archive/evidence/A7-3/reforge-s066-frame-animation.png`
  - `docs/ops/archive/evidence/A7-3/reforge-s066-skip-cleanup.png`
