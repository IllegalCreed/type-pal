...
- 历史已钉证据：`docs/ops/archive/tasks/done/OPS-TST-PERF-test-fixture-stratification.md:351-352`
...
> 已拆卡：[`OPS-TST-PERF-parallel-gates.md`](../cancelled/OPS-TST-PERF-parallel-gates.md)。本节只保留冻结约束，
> 不在本卡直接实现。
...
> 已拆卡：[`OPS-TST-PERF-consolidated-determinism.md`](../cancelled/OPS-TST-PERF-consolidated-determinism.md)。
...
`docs/ops/archive/evidence/OPS-TST-PERF-current-only-baseline-2026-08-22.md`。本卡 A 的历史 done 结论不变。
