...
- 已知坑 / 审计文档:
  - `docs/phase2/specs/editor-design-system.md:180-188,322-327` 当前冻结 `DsInlineComposer` 的同行 density / 响应合同；
    本卡要把“候选追加”和“自由输入 / 短操作”重新分类，不能简单删除 InlineComposer。
  - `docs/phase2/specs/editor-design-system.md:418-426,609-613` adoption / overlay / modal 焦点合同。
  - `docs/phase2/specs/editor-design-system.md:886-893` 大列表性能合同。
  - `docs/ops/archive/tasks/done/ED-PROJECT-STARTUP-IA-1-project-entry-startup-workbench.md` 当前入口 ownership、资源四态与命令证据。
  - `docs/ops/archive/tasks/done/ED-FIELD-COMMIT-1-editor-field-draft-commit-boundary.md` draft / commit / cancel / resync 合同。
...
任务卡：docs/ops/archive/tasks/done/ED-ADD-PICKER-DIALOG-1-editor-collection-add-picker-dialog.md
...
docs/phase2/specs/editor-design-system.md，以及 ED-PROJECT-STARTUP-IA-1 当前范围 / 测试证据。
...
docs/phase2/specs/editor-design-system.md 的 DS-C.4e。重点实现：
