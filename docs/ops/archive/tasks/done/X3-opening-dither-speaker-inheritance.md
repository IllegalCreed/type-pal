...
- 已知坑 / 审计文档：
  - `docs/phase2/archive/audits/w-render-audit.md:301`：dither 属壳层输出特效，不应污染场景渲染模型。
  - `docs/phase2/archive/audits/x-shell-audit.md`：time-based 状态必须有明确收尾人；切场景、读档、abort 不得留下孤儿 Promise/冻屏。
...
任务卡:docs/ops/archive/tasks/done/X3-opening-dither-speaker-inheritance.md
