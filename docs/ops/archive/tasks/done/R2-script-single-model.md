...
- 已拍板决策 / 铁律:
  ...
  - `docs/phase2/archive/designs/content-schema.md:147-149`：脚本是语义动作；不把原 opcode 解释器留作长期运行时。
...
- 已知坑 / 审计文档:
  - `docs/ops/archive/tasks/done/M3-wander-arm-explosion.md:305-315` 留下 66 个产物残余；其中“目标缺失是源悬空”的旧结论经本卡复核后被推翻。
