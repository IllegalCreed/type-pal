...
- 已知坑 / 审计文档:
  - [`docs/phase2/archive/designs/project-design.md`](../../../../phase2/archive/designs/project-design.md) §3：manifest 是工程入口描述，不是让作者直接维护的路径字典。
  - [`docs/phase2/archive/designs/editor-design.md`](../../../../phase2/archive/designs/editor-design.md) §11：工程模块应承载入口点、工程设置、locale、问题面板、保存/导出/资源闭包报告；页面要少而紧凑。
  - [`docs/phase2/archive/audits/editor-authoring-closure-audit-2026-07-13.md`](../../../../phase2/archive/audits/editor-authoring-closure-audit-2026-07-13.md) §§5、7、8：工程模块重排建议、统一引用图 ED-3 和后续顺序。
  ...
  - [`docs/ops/archive/tasks/done/A7-0-resource-closure-registry.md`](A7-0-resource-closure-registry.md) 与 [`A7-3-cutscene-asset-workbench.md`](A7-3-cutscene-asset-workbench.md)：资源角色、稳定 AssetId、视频/RNG 资源页和引用跳转的现行约定。
...
- 2026-07-16 Codex: 根据当前 V3 manifest schema、工程模块设计、编辑器闭环审计和现有入口点实现，起草 X7-1 任务卡；明确工程页字段唯一归属、稳定 id、默认开局继承、ED-3 引用图依赖和保存/重开验收矩阵。Evidence: `packages/content/src/character.ts`、`packages/content/src/asset.ts`、`packages/editor/src/ui/EntryPointTab.tsx`、`docs/phase2/archive/audits/editor-authoring-closure-audit-2026-07-13.md`。Next: Opus 设计/UX 审查。
...
任务卡：docs/ops/archive/tasks/done/X7-1-manifest-project-workbench.md
