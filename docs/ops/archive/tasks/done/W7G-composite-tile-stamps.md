...
- [`editor-design.md`](../../../../phase2/archive/designs/editor-design.md):117-128 是 W8 选择、命中、权限、原子 patch
...
- [`asset-pipeline.md`](../../../../phase2/archive/designs/asset-pipeline.md):78-91 定义迁移地图、tileset 注册和二跑零计划。
...
> 原表保留 W7G 已三签设计的历史表述；当前真值见 `docs/phase2/archive/designs/editor-design.md` §5.2.1。
...
任务卡:docs/ops/archive/tasks/done/W7G-composite-tile-stamps.md
...
先读:AGENTS.md；docs/phase2/READ-FIRST.md；本任务卡全文(含 Kimi 的 S 表逐项结论、S2/S3 节与主审立场)；
      docs/ops/archive/tasks/done/W8-map-content-selection-inspector.md；
      docs/ops/archive/tasks/done/W7B-tileset-library.md；docs/phase2/archive/designs/asset-pipeline.md；
...
先读:AGENTS.md；docs/phase2/READ-FIRST.md；本任务卡全文；
      docs/ops/archive/tasks/done/W8-map-content-selection-inspector.md；
      docs/ops/archive/tasks/done/W7F-canonical-map-pipeline.md；docs/phase2/archive/designs/editor-design.md §5.2.1；
