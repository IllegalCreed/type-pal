...
| 本任务目标 | 由一份规范统一定义 foundations、layout、components、interaction、media、accessibility、implementation contract 与 reference fixtures；用户验收后，所有模块翻新引用条款并记录例外。 | 用户 2026-08-15 拍板“先有一个完整的设计规范，然后按照规范来实施”；`docs/phase2/archive/audits/editor-modernization-follow-up-2026-08-14.md:13-41,81-87` |
...
- 已知坑 / 审计文档:
  - `docs/phase2/archive/audits/editor-modernization-follow-up-2026-08-14.md`：三条后续审查线和规范先行边界。
  - `docs/phase2/archive/audits/editor-authoring-closure-audit-2026-07-13.md`：功能闭环仍沿用 ED-1 七环，不与视觉规范混为一谈。
...
任务卡: docs/ops/archive/tasks/done/ED-DS-1-editor-design-system-spec.md
...
先读: AGENTS.md；docs/phase2/READ-FIRST.md；docs/phase2/archive/audits/editor-modernization-follow-up-2026-08-14.md；
...
先读: 本卡全文（尤其 GLM 独立反证审查 G1-G3 必落钉）；docs/phase2/archive/audits/editor-modernization-follow-up-2026-08-14.md；
...
输出: 规范文档（docs/phase2/guides/ 下）+ fixtures 设计 + 本卡 Build 节证据。
```
...
任务卡: docs/ops/archive/tasks/done/ED-DS-1-editor-design-system-spec.md
规范正文: docs/phase2/specs/editor-design-system.md
...
docs/phase2/archive/audits/editor-modernization-follow-up-2026-08-14.md；Vercel Web Interface Guidelines
请你做:
