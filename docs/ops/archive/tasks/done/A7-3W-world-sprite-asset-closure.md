...
- 已拍板决策 / 铁律:
  ...
  - `docs/phase2/decisions.md:332-351`（D25）：大世界精灵保持 gzip 索引数据，运行时按场景色彩着色；
    创作者不接触颜色表，不能烘死 RGBA。
  - `docs/phase2/reference/phase1-knowledge-harvest.md` E2/E5/MG5：`nSpriteFramesAuto` 的加载语义、
    per-frame 自锚/脚底中心/落笔 `+7px` 和坏尾帧 guard 是一阶段真值。
  - `docs/phase2/archive/audits/a7-resource-closure-audit.md:124-170,359-468`：同一族不能长期保留 catalog 与
    数字/目录两套解析；物理路径只属于 AssetRecord，未引用 catalog 项是 warning 而非缺失 error。
  - `docs/ops/archive/tasks/done/A7-3T-tileset-asset-closure.md`：上一族已冻结 AssetId/AssetRecord 分层、完整 SHA、
...
任务卡: docs/ops/archive/tasks/done/A7-3W-world-sprite-asset-closure.md
...
docs/phase2/reference/phase1-knowledge-harvest.md 的 E2/E5/MG5、
docs/phase2/archive/audits/a7-resource-closure-audit.md、docs/ops/archive/tasks/done/A7-3T-tileset-asset-closure.md，
...
先读: AGENTS.md、docs/phase2/READ-FIRST.md、docs/phase2/decisions.md 的 D25、
docs/phase2/archive/audits/a7-resource-closure-audit.md、docs/phase2/archive/designs/asset-pipeline.md、
docs/ops/archive/tasks/done/A7-3T-tileset-asset-closure.md 和本任务卡全部内容
...
先读: AGENTS.md、docs/phase2/READ-FIRST.md、docs/phase2/decisions.md 的 D25、
docs/phase2/reference/phase1-knowledge-harvest.md 的 E2/E5/MG5、
docs/phase2/archive/audits/a7-resource-closure-audit.md、
docs/ops/archive/tasks/done/A7-3T-tileset-asset-closure.md 和本任务卡全部内容
...
先读: AGENTS.md、docs/phase2/READ-FIRST.md、docs/phase2/decisions.md 的 D25、
docs/phase2/archive/audits/a7-resource-closure-audit.md、docs/ops/archive/tasks/done/A7-3T-tileset-asset-closure.md 和本任务卡
