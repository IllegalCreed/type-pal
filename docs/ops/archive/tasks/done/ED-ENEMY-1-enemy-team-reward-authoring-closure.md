...
- `docs/ops/archive/tasks/done/B10-1-enemy-confused-attack.md`（其中已发布的五槽 `EnemyTeamDef.slots` 模型，不重开槽位决策）
- `docs/ops/archive/tasks/done/ED-BATTLE-UI-1-skill-workbench-redesign.md`（只提供页面壳/视觉上下文，不替代本卡功能闭环）
...
任务卡：docs/ops/archive/tasks/done/ED-ENEMY-1-enemy-team-reward-authoring-closure.md
