...
- 已知坑 / 审计文档:
  - `docs/ops/archive/tasks/done/A7-2-static-images-engine-chrome.md:193-202` 已冻结 `face?` 缺席语义，但当时错误把 face 数量冻结为 6。
...
任务卡: docs/ops/archive/tasks/done/MIG-PAL-ACTOR-FACE-1-pal-actor-face-absence.md
当前状态: draft
