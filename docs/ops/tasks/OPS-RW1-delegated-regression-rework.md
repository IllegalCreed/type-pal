...
- 根 `pnpm lint` 当前 119 errors；必须恢复零 error，不用格式化或覆盖用户未提交的
  `docs/ops/tasks/D14-3-reward-event-bus.md`。
...
- 当前工作树已有用户改动：`M docs/ops/tasks/D14-3-reward-event-bus.md`；Coding Owner 必须逐字节
  保留，不纳入格式化、回退或任务卡收口。

### 必读设计 / 历史卡

- `docs/ops/tasks/N3-1-script-control-flow-modernization.md`
- `docs/ops/tasks/JS1-jiu-shen-nine-use-limit.md`
- `docs/ops/tasks/B11-1-player-casualty-scripts.md`
- `docs/ops/tasks/ED-5J-item-private-script-create.md`
- `docs/ops/tasks/D13-1-debug-tools-first-batch.md`
- `docs/ops/tasks/E18-1-editor-actor-battle-fields.md`
- `docs/ops/tasks/D12-1-audio-transition-layering.md`
- `docs/ops/tasks/D6-1-occlusion-semi-transparent.md`
- `docs/ops/tasks/D14-3-reward-event-bus.md`
