...
- 规范：`docs/phase2/editor/editor-design-system-v1.md:326-389`（列表头/搜索/过滤）、`:553-590`
...
docs/phase2/editor/editor-design-system-v1.md、ED-DS-1、ED-DS-2、ED-AUDIT-2、本任务卡；再直接读
