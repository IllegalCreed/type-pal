...
| 完成证据 | R2 状态 done，Capability 明列 X3；三方 implementation accept；用户 2026-07-14 明确「齐了」；提交已在 HEAD；s281 全链两条独立浏览器路径均到 `?menu` 且零错误 | `docs/ops/tasks/R2-script-single-model.md:3-5,357-375,385-408`; commit `76df4665a67ce7665b9a848c072fc1205bbc8c16` |
...
- 代码 / 文档锚点: 见真值矩阵；另见 `docs/ops/tasks/R2-script-single-model.md` 完整验收记录。
- 已知坑 / 审计文档:
