...
| [TEST-COVERAGE-TRUTH-1 - 类初始化覆盖率合并真值修复](TEST-COVERAGE-TRUTH-1-class-initializers.md) | review | 以任务卡当前准入与看板分工为准。 |
| [TEST-RUNTIME-SHELL-COVERAGE-1 - 真实启动与菜单宿主流程补测](TEST-RUNTIME-SHELL-COVERAGE-1-boot-menu-flows.md) | review | 以任务卡当前准入与看板分工为准。 |
