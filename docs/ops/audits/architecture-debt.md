...
| A3 Reforge世界/帧循环（[首段build](../tasks/ARCH-REFORGE-FRAME-1-clock-and-input.md)） | main.ts:995、:1780、:4055、:4940、:6288（原盘点基点）；首段重新定位b11d4bc9时间/等待/tick | 首段迁时间/单步/等待所有权与帧、输入编排；场景事务/移动/绘制剩余续段，不提前算整批done | 不重写移动模型/碰撞规则；沿用既有原子提交/epoch合同 |
