...
| A3 Reforge世界/帧循环（[首段done](../archive/tasks/done/ARCH-REFORGE-FRAME-1-clock-and-input.md)，整体未完成） | main.ts:995、:1780、:4055、:4940、:6288（原盘点基点）；首段以b11d4bc9重定位 | 8eb93bb7迁时间/单步/等待所有权与帧、输入编排，main6486→6427；场景事务/移动/绘制续段未完成 | 36新增/11针/check8499/strict8008/639；移动/场景/绘制算法AST保真，19函数保护 |
