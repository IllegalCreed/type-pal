/**
 * ARCH-REGRESSION-LAB-GLM-1 · G03 App 所有权生命周期（正式回归）。
...
vi.mock('../../ui/SceneCanvas.js', () => ({ SceneCanvas: () => <div /> }))
vi.mock('../../core/author-save-store.js', async (original) => {
  const fixture = await import('../../core/__tests__/author-save-store-fixture.js')
...
beforeEach(async () => {
  ...
  const { authorSaveStorage } = await import('../../core/__tests__/author-save-store-fixture.js')
