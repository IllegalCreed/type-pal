...
const MODULE_MENUS: DsMenuDefinition[] = [
  ...
  },
  {
    ...
    layout: 'section-grid',
    items: [
      { id: 'nav-scene', label: '场景工作台', section: '场景', href: '?module=scene' },
      { id: 'nav-map', label: '地图工作台', section: '地图', href: '?module=map' },
      { id: 'nav-story', label: '剧情工作台', section: '剧情', href: '?module=story' },
      { id: 'nav-actor', label: '角色工作台', section: '角色', href: '?module=actor' },
      { id: 'nav-item', label: '物品工作台', section: '物品', href: '?module=item' },
      { id: 'nav-skill', label: '技能', section: '战斗', href: '?module=battle&page=skill' },
      { id: 'nav-enemy', label: '敌人', section: '战斗', href: '?module=battle&page=enemy' },
      { id: 'nav-poison', label: '毒', section: '战斗', href: '?module=battle&page=poison' },
      {
        id: 'nav-battlefield',
        label: '战场',
        section: '战斗',
        href: '?module=battle&page=battlefield',
        current: true,
      },
      { id: 'nav-asset', label: '资源工作台', section: '资源', href: '?module=asset' },
      { id: 'nav-project', label: '项目设置', section: '项目', href: '?module=project' },
    ],
  },
]
