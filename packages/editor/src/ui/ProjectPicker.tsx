/**
 * 编辑器启动屏。只负责创建、选择和打开当前 canonical content20 项目；旧开发项目必须
    ...
    <div className="picker">
      <div className="picker-card">
        ...
        <p className="picker-sub">
          选择当前 canonical content20 项目开始编辑。旧开发项目请重新生成。
        </p>
          ...
          <>
            <div className="picker-actions">
              ...
              <DsPressable type="button" className="picker-act" onClick={openProject}>
                ...
                <span className="picker-act-d">选择一个当前 content20 本地项目继续编辑。</span>
              </DsPressable>
              <DsPressable type="button" className="picker-act" onClick={createBlank}>
                <span className="picker-act-t">新建空白项目</span>
                <span className="picker-act-d">创建包含起始场景与占位角色的 content20 项目。</span>
              </DsPressable>
            </div>
