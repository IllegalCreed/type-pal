 ...
 *
 * 只从权威 v4 纯迁移构建累计 P2/P3 IR，默认构建最新 P3 并写入 gitignored shadow 根；
...
const phase = options.through.toUpperCase() as 'P2' | 'P3'
...
const assertBundle = options.through === 'p2' ? assertP2ShadowBundle : assertP3ShadowBundle
assertBundle(bundle)
