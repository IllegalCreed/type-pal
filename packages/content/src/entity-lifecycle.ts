/** 持久实体生命周期；缺少条目严格等价于 normal。 */
export type EntityLifecycleEntry =
...
export type EntityLifecycleTable = Record<string, Record<string, EntityLifecycleEntry>>

export type EntityLifecycleReferenceIndex = ReadonlyMap<string, ReadonlySet<string>>

export interface EntityLifecycleSceneReference {
  id: string
...
function checkEntry(value: unknown, path: string): asserts value is EntityLifecycleEntry {
...
export function checkEntityLifecycleTable(
  value: unknown,
  path = 'entityLifecycles',
): asserts value is EntityLifecycleTable {
...
export function buildEntityLifecycleReferenceIndex(
  scenes: readonly EntityLifecycleSceneReference[],
...
export function normalizeEntityLifecycleTable(
  value: unknown,
  references: EntityLifecycleReferenceIndex,
  path = 'entityLifecycles',
): EntityLifecycleTable {
  if (value === undefined) return {}
  checkEntityLifecycleTable(value, path)
