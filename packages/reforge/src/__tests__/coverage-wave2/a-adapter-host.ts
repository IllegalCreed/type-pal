...
export const wave2DispatchCommands = (): RuntimeCommand[] => [
  ...
  { kind: 'fade', dir: 'out' },
  { kind: 'chasePlayer', range: 6, speed: 2 },
  { kind: 'loadLastSave' },
  { kind: 'gameOver' },
  { kind: 'teleportParty', pos: { col: 3, row: 4, height: 0 }, facing: 'down' },
  ...
  { kind: 'moveParty', to: { col: 5, row: 5, height: 0 }, speed: 'normal' },
