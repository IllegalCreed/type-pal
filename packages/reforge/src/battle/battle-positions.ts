...
export const ENEMY_POSITIONS_BY_COUNT: ReadonlyArray<ReadonlyArray<{ x: number; y: number }>> = [
  [{ x: 100, y: 110 }],
  [{ x: 70, y: 130 }, { x: 140, y: 106 }],
  [{ x: 70, y: 140 }, { x: 100, y: 110 }, { x: 160, y: 100 }],
  [{ x: 70, y: 140 }, { x: 100, y: 110 }, { x: 160, y: 100 }, { x: 50, y: 100 }],
  [{ x: 70, y: 140 }, { x: 100, y: 110 }, { x: 160, y: 100 }, { x: 30, y: 110 }, { x: 90, y: 80 }],
]
...
export function getEnemyBasePos(
  ...
  const layout = ENEMY_POSITIONS_BY_COUNT[Math.min(enemyCount - 1, ENEMY_POSITIONS_BY_COUNT.length - 1)]
