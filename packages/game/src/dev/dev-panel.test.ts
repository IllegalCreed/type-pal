...
// collect* 纯函数(collectPartyStatusReadouts / collectEnemyStatusReadouts / collectFieldInfoReadout)
//   已抽到 ../core/inspect/battle-inspect.ts,其测试随之搬到 battle-inspect.test.ts。
