...
import { type GameState, projectRuntimeToBattleRoles } from '../../../core/game-state.js'
import {
  confirmCaster,
  confirmSpell,
  ...
  inGameMagicMoveDown,
  inGameMagicPageDown,
} from '../../../core/menu/in-game-magic-menu.js'
import {
  MENUITEM_COLOR,
...
import { drawInGameMagicMenu } from '../../menu/draw-magic.js'
...
import { cloneInputs, freezeNow, makeGs, makeRoles, resetHostSingletons } from './world.js'
