...
- **第二阶段 · Reforge 重制(早期、活跃)** —— 全新引擎 + 内容编辑器 + 自有内容,**不对齐旧引擎 / 原版行为,架构优先**;第一阶段的「真值锚 / 双引擎对照」方法论在此**整体作废**。当前在第一刀:[`packages/reforge`](packages/reforge/) 的 Canvas 2D「鬼界民居」demo。开工铁律见 [`docs/phase2/READ-FIRST.md`](docs/phase2/READ-FIRST.md),总纲见 [`docs/phase2/roadmap.md`](docs/phase2/roadmap.md)。
...
| [`docs/phase1/status/cutscene-status.md`](docs/phase1/status/cutscene-status.md) | 507 段自动演出的风险分级和逐场景清单。 |
| [`docs/phase1/game-mechanics.md`](docs/phase1/game-mechanics.md) | 战斗底层机制真值,包含伤害、暴击、隐藏经验、五灵抗性、出手顺序等。 |

近期审计收口:

- 2026-06-07 第一轮全子系统差异审计:
  [`docs/phase1/plans/2026-06-07-sdlpal-diff-audit.md`](docs/phase1/plans/2026-06-07-sdlpal-diff-audit.md)。
  70 条候选、64 条确认差异,已全部逐条修复。
- 2026-06-10 第二轮执行路径级深挖:
  [`docs/phase1/plans/2026-06-10-sdlpal-deep-audit.md`](docs/phase1/plans/2026-06-10-sdlpal-deep-audit.md)。
...
> `docs/phase1/plans/` 是历史档案,不代表当前状态。查现状先读上面的状态表和
> [`docs/phase1/plans/README.md`](docs/phase1/plans/README.md)。
...
| 路径 | 内容 |
|---|---|
| [`docs/`](docs/README.md) | 文档总入口,按阶段分文件夹(从 docs/README 开始导航)。 |
| [`docs/phase1/`](docs/phase1/README.md) | 第一阶段文档:状态表、架构决策、工程经验、历史计划(`plans/`)。新读者看这。 |
| [`docs/phase2/`](docs/phase2/README.md) | 第二阶段(Reforge):铁律、路线图、内容 schema、对话 / 切片 spec。 |
